...
luckdog88
App Key£º602856867
App Secret£ºd281f8bdd589ba6166609520df65da0c
'''
...
"""read ids"""
dataReader = csv.reader(open('C:/Python27.3/weibo/repostsSample3.csv', 'r'), delimiter=',', quotechar='|')
ids = []
...
addressForSavingData= "C:/Python27.3/weibo/diffsersSaveAll2(2733).csv"    
...
lenid = len(ids)
# lenid = 8 # test with the first two cases

for n in range(2733, lenid+1):  # the 78 should be 77 here
