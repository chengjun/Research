...
"""read ids"""
dataReader = csv.reader(open('C:/Python27.3/weibo/sample3Recrawl17big.csv', 'r'), delimiter=',', quotechar='|')
ids = []
...
addressForSavingData= "C:/Python27.3/weibo/diffsersSaveRecrawl17big8.csv"    
...
for n in range(7, 8):  # the 4th  should be (3, 4)
	try:
