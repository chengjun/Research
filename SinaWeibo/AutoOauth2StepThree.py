...
luckdog88
602856867
d281f8bdd589ba6166609520df65da0c
'''
...
'''Step 3 '''
"""read ids"""
dataReader = csv.reader(open('C:/Python27.3/weibo/socialgraphReSaveError2.csv', 'r'), delimiter=',', quotechar='|')
ids = []
...
addressForSavingData= "C:/Python27.3/weibo/socialgraphReSave2e.csv"  
file = open(addressForSavingData,'wb') # save to csv file 

addressForSavingError = "C:/Python27.3/weibo/socialgraphReSaveError2e.csv"  
...
# addressForSavingData= "C:/Python27/weibo/diffsersSaveAll2(78-).csv"    
# file = open(addressForSavingData,'wb') # save to csv file 
...
# for n in range(77, lenid+1):  # the 78 should be 77 here
	# rate = client.get.account__rate_limit_status()
	# sleep_time = rate.reset_time_in_seconds + 300
	# remaining_ip_hits = rate.remaining_ip_hits
	# remaining_user_hits = rate.remaining_user_hits
