...
class API(object):
    ...
    def upload(self, filename, status, lat=None, long=None, source=None):
        ...
        headers, post_data = API._pack_image(filename, 1024, source=source, status=s1, lat=lat, long=long, contentname="pic")
...
""" statses/repost_timeline """
    ...
    """ Internal use only """
    @staticmethod
    def _pack_image(filename, max_size, source=None, status=None, contentname="image", lat=None, long=None):
